...
which.g <- which(rgr_msh_na_raw$SampleID%in%na.omit(rgr_msh_na_raw[,c(1,environ_name)])$SampleID)
TW_G_Plot_NA$SampleID <- rgr_msh_na_raw$SampleID[which.g]
RGR_MSH_NA_PCA<- merge(rgr_msh_na_raw, TW_G_Plot_NA, by = "SampleID")
